...
export interface EventSubscriber {
  ...
  // Backlog for Last-Event-ID reconnection: events with id > afterId, oldest-first, plus the
  // oldest retained id so callers can prove whether the retained log covers the cursor.
  replay(boardId: string, afterId: string): Promise<ReplayResult>;
